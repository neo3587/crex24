...
/*
	Author: neo3587
	Source: https://github.com/neo3587/crex24

	NOTES:
		- Crex24Market methods doesn't require authorization.
		- R1 access permission methods:
			+ Crex24.trading.orders_status()
			+ Crex24.trading.order_trades()
			+ Crex24.trading.active_orders()
			+ Crex24.trading.order_history()
			+ Crex24.trading.trade_history()
			+ Crex24.trading.trade_fee()
			+ Crex24.account.balances()
		- R2 access permission methods:
			+ Crex24.trading.place_order()
			+ Crex24.trading.modify_oreder()
			+ Crex24.trading.cancel_order_by_id()
			+ Crex24.trading.cancel_olcer_by_instrument()
			+ Crex24.trading.cancel_all_orders()
		- R3 access permission methods:
			+ Crex24.account.deposit_address()
			+ Crex24.account.money_transfers()
			+ Crex24.account.money_transfer_status()
			+ Crex24.account.preview_withdrawal()
		- R4 access permission methods:
			+ Crex24.account.withdraw()
*/
...
class Crex24Trading {
	...
	*/
	...
	/** Modifies the price and/or volume of an existing order. In order to invoke this method, authentication key must have R2 access permission
	* @param {number} id - ID of the order for which the information about trades is requested
